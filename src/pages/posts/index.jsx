                ...
                <Box key={status} sx={{ mt: 4 }}>
                    ...
                    <Grid container spacing={2}>
                        {getTasksByStatus(status).map((task, index) => (
                            <Grid className="border-t border-b border-primary py-4" item xs={12} sm={6} md={4} key={index}>
                                <Card className="outlined border border-primary hover:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.3)]">
                                    <CardContent>
